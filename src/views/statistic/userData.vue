    ...
    <div class="search_box" style="padding-left:30px;">
      ...
      <p>
        <el-radio-group v-model="tabPosition2" style="margin-bottom: 15px;">
          <el-radio-button label="1">新增用户量</el-radio-button>
          <el-radio-button label="2">活跃用户量</el-radio-button>
          <el-radio-button label="3">日均在线时长</el-radio-button>
          <el-radio-button label="4">日启动次数</el-radio-button>
        </el-radio-group>
      </p>
